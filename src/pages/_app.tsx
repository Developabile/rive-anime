...
export default function App({ Component, pageProps }: any) {
  ...
  return (
    <>
      <Head>
        <title>RiveKun</title>
        <meta name="description" content="Your Portal to Anime Adventures" />
        <meta
          name="keywords"
          content="anime, streaming, download, rive, rivekun, kun"
        />
        <meta
        ...
        <meta name="apple-mobile-web-app-title" content="RiveKun" />
